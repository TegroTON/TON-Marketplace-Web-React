          ...
          <section className="item-details section pt-5">
            <Container fluid>
              <Breadcrumb className="mb-4">
                ...
                <Breadcrumb.Item
                  href={`/collection?a=${collection ? rawToTon(collection.address) : ''}`}
                >
                  ...
                  <div className="card-item-details mb-5">
                    <div className="card-item-head d-flex mb-4">
                      {oneItem.sale ? (
                        ...
                        <div className="item-details__badge badge__purple me-auto">
                          Not For Sale
                        </div>
                      )}
                          ...
                          <OverlayTrigger
                            ...
                            overlay={
                              <Tooltip id={'tooltip-bottom'}>
                                We will use this value to cover blockchain fees and send the rest
                                back to you.
                              </Tooltip>
                            }
                          >
                  ...
                  <Row>
                    {account ? (
                      <Col md="6" lg="12" xl="6" className="mx-auto mb-4">
                        ...
                        <Card className="p-3 p-sm-0 border mb-3">
                          <Card.Link
                            href={`/user?a=${rawToTon(oneItem.owner?.address)}`}
                            className="d-block d-sm-flex align-items-center text-center text-sm-start"
                          >
                            <Card.Img
                    ...
                    {collection ? (
                      <Col md="6" lg="12" xl="6" className="mx-auto mb-4">
                        ...
                        <Card className="p-3 p-sm-0 border mb-3">
                          <Card.Link
                            href={`/collection?a=${rawToTon(collection.address)}`}
                            className="d-block d-sm-flex align-items-center text-center text-sm-start"
                          >
                            <Card.Img
                              variant="collection m-3 m-lg-0"
                  ...
                  <Card className="border p-4 mb-4">
                    ...
                    <ListGroup variant="flush" className="p-0 bg-transparent">
                      <ListGroup.Item className="p-0 border-0 mb-3">
                        <a
                          href={`https://tonscan.org/address/${rawToTon(oneItem.address)}`}
                          className="d-flex align-items-center p-3 rounded border hover text-white"
                          target="_blank"
                        >
                          <div className="fw-medium color-grey">Contract Address</div>
                          <div className="col-4 text-truncate ms-auto">
                            {rawToTon(oneItem.address)}
                          </div>
                      ...
                      {oneItem.sale ? (
                        <ListGroup.Item className="p-0 border-0 mb-3">
                          <a
                            href={`https://tonscan.org/address/${rawToTon(oneItem.sale.address)}`}
                            className="d-flex align-items-center p-3 rounded border hover text-white"
                            target="_blank"
                          >
                            <div className="fw-medium color-grey">Sale Contract</div>
                            <div className="col-4 text-truncate ms-auto">
                              {rawToTon(oneItem.sale.address)}
                            </div>
                            <i className="fa-solid fa-angle-right color-grey ms-3" />
                          </a>
                        </ListGroup.Item>
                      ...
                      <Row>
                        {oneItem.metadata.attributes.map((attr, key) => (
                          <Col lg="6" className="mb-3" key={key}>
                            ...
                            >
                              <div className="me-auto">
                                <span className="d-block fs-14 fw-medium color-grey mb-2">
                                  {attr.trait_type}
                                </span>
              ...
              <h2 className="fs-28 fw-bold mb-4">More From This Collection</h2>
