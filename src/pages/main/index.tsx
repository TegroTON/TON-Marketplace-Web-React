                ...
                <section className="collections section">
                    <Container className="collection__container container-fluid">
                        ...
                        <div className="mt-5 text-center">
                            <a href="/explore" className="btn btn-primary">See all <i className="fa-solid fa-arrow-right ms-2"></i></a>
                        </div>
                    </Container>
                </section>
                     ...
                     TON is in beta <span className="d-block d-md-inline">on Libermall</span>
                        ...
                        <div className="libermall__buttons d-flex align-items-center">
                            ...
                            <div className="libermall__soclinks ms-5 d-none d-md-flex">
                                <a href="https://t.me/libermallru" target="_blank" className="libermall__soclinks-item"><i className="fa-brands fa-telegram"></i></a>
                                {/* <a href="#!" className="libermall__soclinks-item"><i className="fa-brands fa-discord"></i></a> */}
                                <a href="https://twitter.com/libermallnft" target="_blank" className="libermall__soclinks-item"><i className="fa-brands fa-twitter"></i></a>
