            ...
            <Row>
                  ...
                  <Card.Body className="p-2 p-xl-4">
                    <div className="d-flex mb-4">
                      ...
                      <div className="ms-3 w-100">
                        <Card.Title className="fs-28 fw-bold mb-2 me-3 text-wrap">uNerd</Card.Title>
                ...
                <div id="open-filters" className="modal-mobile">
                  <Card className="card-filters bg-transparent">
                    <div className="d-flex align-items-center py-4 border-bottom">
                      ...
                      <a href="#!" className="fw-medium link fs-16 d-none d-lg-block ms-auto">
                        Clear
                      </a>
                      <a
                        href="#!"
                        className="mobile-modal-close fw-medium link fs-16 d-block d-lg-none ms-auto"
                      >
                        <i className="fa-solid fs-24 fa-xmark"></i>
                      </a>
                    </div>
                    ...
                    <Card.Body className="p-0 border-bottom">
                      ...
                      <div id="flexRadio-SaleType" className="collapse show">
                        <Form.Check
                          ...
                          type="radio"
                          id="Radio-AllTypes"
                          className="hover p-3 mb-1 w-100"
                          label={
                            <>
                    ...
                    <Card.Body className="p-0 border-bottom">
                      ...
                      <div id="collapseCollectionType" className="collapse show">
                        <Form.Check
                          name="checkbox"
                          type="checkbox"
                          id="flexCheck-collection-1"
                          className="hover p-3 mb-1 w-100"
                          label={
                            <>
                              <img
                                className="card-img-collection mx-3 rounded-12"
              ...
              <Col lg="8" xxl="9">
                ...
                >
                        ...
                        <Card>
                          <Card.Link href="/collection-item" className="card-link">
                            ...
                            <Card.Body>
                              ...
                              <Card.Title className="mb-3">Pinocchio</Card.Title>
                        ...
                        <Card>
                          <Card.Link href="/collection-item" className="card-link">
                            ...
                            <Card.Body>
                              ...
                              <Card.Title className="mb-3">RED HOPE</Card.Title>
                              <Card.Text className="d-flex align-items-center color-grey fs-18">
                          ...
                          <div
                            ...
                            style={{
                              background:
                                'url(./assets/img/nfts/nft-2.png)  no-repeat center center / cover',
                            }}
                          />
                        </Card>
                      </Col>
                        ...
                        <Card>
                          <Card.Link href="/collection-item" className="card-link">
                            ...
                            <Card.Body>
                              ...
                              <Card.Title className="mb-3">CAT ETH</Card.Title>
                              <Card.Text className="d-flex align-items-center color-grey fs-18">
                          ...
                          <Button variant="icon btn-like btn-like__card">
                            <i className="fa-regular fa-heart fs-18 me-2" />4
                          </Button>
                          <Button
                            variant="primary btn-sm card__show-effect"
                            data-bs-toggle="modal"
                          ...
                          <div
                            ...
                            style={{
                              background:
                                'url(./assets/img/nfts/nft-3.png)  no-repeat center center / cover',
                            }}
                          />
                        </Card>
                      </Col>
                        ...
                        <Card>
                          <Card.Link href="/collection-item" className="card-link">
                            ...
                            <Card.Body>
                              ...
                              <Card.Title className="mb-3">TON CYBER GIRL</Card.Title>
                              <Card.Text className="d-flex align-items-center color-grey fs-18">
                                <span className="icon-ton me-2"></span>
                                50
                              </Card.Text>
                          ...
                          <div
                            ...
                            style={{
                              background:
                                'url(./assets/img/nfts/nft-4.png)  no-repeat center center / cover',
                            }}
                          />
                        </Card>
                      </Col>
                  ...
                  <Tab eventKey="Created" title="Created">
                    <Card className="text-center p-5">
                      ...
                      <div className="fs-28 fw-bold">
                        The user has <br /> no created NFTs.
                      </div>
                      <Card.Text className="color-grey mt-2">
                        After minting, NFTs will be displayed in this section <br /> and visible to
                        other users.
                      </Card.Text>
                    </Card>
                  </Tab>
                        ...
                        <Card>
                          <Card.Link href="/collection" className="card-link">
                            ...
                            <Card.Body className="d-flex align-items-center mt-2">
                              <Card.Title className="mb-0">Animals Red List</Card.Title>
                              <span className="verified-icon ms-2" />
                            </Card.Body>
                          </Card.Link>
                          <div
                        ...
                        <Card>
                          <Card.Link href="/collection-item" className="card-link">
                            ...
                            <Card.Body>
                              ...
                              <Card.Title className="mb-3">TON NFT Tegro Cat (6452)</Card.Title>
                              <Card.Text className="d-flex align-items-center color-grey fs-18">
                                <span className="icon-ton me-2"></span> 3
                          ...
                          <div className="card-status fw-500">
                            <i className="fa-regular fa-gavel me-2 fs-18" />7 days
                          </div>
                          <div
                            className="card__blur-bg-hover"
                            style={{
                        ...
                        <Card>
                          <Card.Link href="/collection-item" className="card-link">
                            ...
                            <Card.Body>
                              ...
                              <Card.Title className="mb-3">TON NFT Tegro Cat (2144)</Card.Title>
                              <Card.Text className="d-flex align-items-center color-grey">
                                Not For Sale
                              </Card.Text>
                            </Card.Body>
                          ...
                          <div
                            ...
                            style={{
                              background:
                                'url(./assets/img/cats/2.png)  no-repeat center center / cover',
                            }}
                          />
                        </Card>
                      </Col>
                  ...
                  <Tab eventKey="MyOffers" title="My Offers"></Tab>
                </Tabs>
              </Col>
            </Row>
          </Container>
