    ...
    return (
        <div id={props.id}>
            <section className="nft-hero">
                <img
                    src={collection && collection.metadata && collection.metadata.cover_image ? collection.metadata.cover_image : '/assets/img/hero-image.jpg'}
                    className="nft-hero__image" loading="lazy" width="340" height="275" />
            </section>
