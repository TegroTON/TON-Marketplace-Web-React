                  ...
                  {/* <div id="open-filters" className="modal-mobile">
                    <Card className="card-filters bg-transparent">
                      ...
                      <Card.Body className="p-0 border-bottom">
                        ...
                        >
                          <Card.Title className="card-filters__name fs-18 m-0">
                            Event Type
                          </Card.Title>
                  ...
                  >
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="card-blur__item p-4 border-end text-center">
                        <h5
                          className="text-uppercase fs-14 color-grey"
                          style={{ letterSpacing: '1px' }}
                        >
                          floor
                        </h5>
                        <div
                          className="m-0 text-uppercase fw-medium"
                          style={{ letterSpacing: '1px' }}
                        >
                          0.00 TON
                        </div>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div className="table-stats d-flex align-items-center">
                                  ...
                                  <a href="/collection-item" className="d-flex align-items-center">
                                    <img
                                      src="/assets/img/cats/1.png"
                                      className="rounded-12"
                                      style={{ width: '32px', height: '32px' }}
                                    />
                                    <span className="table-stats__name fw-medium ms-3">
                                      TON NFT Tegro Cat (6452)
                                    </span>
                                  </a>
                                </div>
                              ...
                              <td className="text-end">
                                <a
                                  href="/user1"
                                  className="table-stats__from d-flex align-items-center justify-content-lg-end"
                                  target="_blank"
                                >
                                  <img
                              ...
                              <td>-</td>
                              <td className="text-end">2 hours ago</td>
                            </tr>
                            <tr>
                              <td>
                                <div className="table-stats d-flex align-items-center">
                              ...
                              <td className="text-end">3 min ago</td>
                            </tr>
                            <tr>
                              <td>
                                <div className="table-stats d-flex align-items-center">
                              ...
                              <td>-</td>
                              <td className="text-end">12 min ago</td>
                            </tr>
                            <tr>
                              <td>
                                <div className="table-stats d-flex align-items-center">
                                  ...
                                  <a href="/collection-item" className="d-flex align-items-center">
                                    <img
                                      src="/assets/img/cats/4.png"
                                      className="rounded-12"
                                      style={{ width: '32px', height: '32px' }}
                                    />
                                    <span className="table-stats__name fw-medium ms-3">
                                      TON NFT Tegro Cat (3264)
                                    </span>
                                  </a>
                                </div>
                              </td>
                              ...
                              <td>
                                ...
                                >
                                  <img
                                    src="./assets/img/nfts/nft-2.png"
                                    className="table-stats__avatar"
                                    alt=""
                                  />
                                  <div className="table-stats__address ms-2">
                                    iRetnuY7nMKXFEQDZr7KDKG0R4Kyauz-IEQn4-44vzygNEvj
                                  </div>
                                </a>
                              </td>
                              <td className="text-end">3 min ago</td>
                            ...
                            <tr>
                              ...
                              <td>-</td>
                              <td className="text-end">12 hours ago</td>
                            </tr>
                          </tbody>
                        </Table>
                      </Card>
