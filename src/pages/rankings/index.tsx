        ...
        <section className="collections section">
          <Container fluid>
            <div className="d-flex flex-column flex-sm-row align-items-center mb-5">
              <h1 className="section__title fs-40 mb-4 mb-sm-0 me-3 me-auto">Collection stats</h1>
            ...
            <div className="flex-table">
              <div className="flex-thead">
                <div className="flex-th">Collection</div>
                <div className="flex-th text-end">Volume</div>
                <div className="flex-th d-none d-lg-block text-end">Change</div>
                <div className="flex-th d-none d-lg-block text-end">Floor Price</div>
                <div className="flex-th d-none d-lg-block text-center">Sales</div>
                <div className="flex-th d-none d-lg-block text-end">Unique Owers</div>
                <div className="flex-th d-none d-lg-block text-end">Item Listeds</div>
              </div>
              <div className="flex-tbody">
                <a href="/collection" className="card flex-tr p-0 pe-4 flex-row">
                  ...
                  <div className="flex-td text-end">
                    ...
                    <div className="flex-td__ChangeUp color-green small d-block d-lg-none mt-1">
                      +22%
                    </div>
                  </div>
                  ...
                  <div className="flex-td d-none d-xl-block text-end">
                    ...
                    <div className="flex-td__ListedsNum color-grey fw-medium fs-14">
                      337 of 9 998
                    </div>
                  </div>
                  <div
                ...
                <a href="/collection" className="card flex-tr p-0 pe-4 flex-row">
                  ...
                  <div className="flex-td text-end">
                    ...
                    <div className="flex-td__ChangeDown color-red small d-block d-lg-none mt-1">
                      -3%
                    </div>
                  </div>
                  <div className="flex-td d-none d-lg-block text-end">
