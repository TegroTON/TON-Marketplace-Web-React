...
import { Account, AccountV2, Item } from '../../logic/tonapi';
...
export const User1: React.FC<PageProps> = (props: PageProps) => {
  ...
  async function loadItems(address2: string) {
    if (address2 === '') {
      return undefined;
    }
    const data = await marketNFT.getItemsFromUser(address2, page);
    if (!data) {
      return undefined;
    }
  ...
  useEffect(() => {
    if (!firstRender) {
      ...
      const address2 = getParameterByName('a');
  ...
  return (
    <div id={props.id}>
      {/* ! If the banner is Loaded !
         ...
         */}
      <div
        className="nft-hero hero__no-cover"
        style={{ background: 'url(./assets/img/my-avatar.png) no-repeat center center / cover' }}
      ></div>
                  ...
                  <Card.Body className="p-2 p-xl-4">
                    ...
                    <div className="mb-4">
                      <div className="mb-2">
                        ...
                        <p>
                          We have one of the most popular NFT-collections on the TON blockchain...
                        </p>
                      </div>
                      <Button variant="link">
