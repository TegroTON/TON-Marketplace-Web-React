  ...
  return (
    <div id={props.id}>
      ...
      <div className="modal fade" id="ConnectModal" tabIndex={-1} aria-hidden="true">
        <Modal.Dialog className="modal-dialog-centered mobile-modal-bottom">
          ...
          <Card.Text className="color-grey pe-5 mb-4">
            A wallet is a simple, anonymous way to log in. To create ('mint') or buy an NFT, you
            must connect a wallet or create a new one.
          </Card.Text>
          <Modal.Body>
            <Button
            ...
            <Button
              ...
              onClick={() => {
                if (props.DelabObject.tonConnectWallets) {
                  props.DelabObject.connectTonkeeper(
                    props.DelabObject.tonConnectWallets[0] as WalletInfoRemote,
                  );
                }
              }}
            >
              <img
                src="./assets/img/tonkeeper.png"
                alt="Tonkeeper"
                width="40"
                height="40"
                className="wc-img"
          ...
          {props.modalData && props.modalData.metadata ? (
            <Modal.Body>
              <Card className="flex-row bg-soft p-2 mb-3">
                <Card.Img
                  variant="custom rounded image-80x80"
                ...
                <Card.Body>
                  ...
                  <Card.Text className="mb-0 color-grey fs-14">
                    {props.modalData.collection?.name}
                  </Card.Text>
                </Card.Body>
              </Card>
              ...
              >
                Buy For {fixAmount(props.modalData.sale?.price.value ?? 0)} TON
              </Button>
            </Modal.Body>
          ) : null}
        </Modal.Dialog>
          ...
          <Modal.Body>
            ...
            <Form.Group className="mb-4">
              ...
              <InputGroup className="mb-2">
                <Form.Control defaultValue={21} placeholder="Min is 21 TON" type="text" />
                <InputGroup.Text>TON</InputGroup.Text>
              </InputGroup>
              <Form.Text>
                <div className="fs-14 fw-medium">The last bid is 1 TON</div>
                <div className="color-grey">
                  Your bid must be higher than the last bid by 20 TON.
                </div>
              </Form.Text>
            </Form.Group>
            <Alert key="warning" variant="warning mb-4">
              ...
              <p>
                Libermall is unaffiliated with any NFT projects. We are not responsible for possible
                losses. Invest at your own risk.
              </p>
              <Alert.Link href="#">Learn More</Alert.Link>
            </Alert>
            <Button
            ...
            <Form>
              ...
              <Form.Group className="mb-4">
                ...
                <div className="d-flex mb-2">
                  <Button variant="secondary m-1 p-2" onClick={() => setPercentage('0%')}>
                    0%
                  </Button>
                  <Button variant="secondary m-1 p-2" onClick={() => setPercentage('10%')}>
                    10%
                  </Button>
                  <Button variant="secondary m-1 p-2" onClick={() => setPercentage('20%')}>
                    20%
                  </Button>
                  <Button variant="secondary m-1 p-2" onClick={() => setPercentage('30%')}>
                    30%
                  </Button>
                </div>
                <Form.Text className="color-grey">
                  Collect royalties every time your NFT is sold. The amount is deducted from the
              ...
              <Form.Group className="mb-4">
                ...
                <InputGroup className="mb-3">
                  ...
                  <Form.Control placeholder="" aria-label="telegram" className="ps-0" />
                </InputGroup>
                <InputGroup className="mb-3">
                  <InputGroup.Text className="d-flex align-items-center pe-0">
                  ...
                  <Form.Control placeholder="" aria-label="twitter" className="ps-0" />
                </InputGroup>
                <InputGroup className="mb-3">
                  <InputGroup.Text className="d-flex align-items-center pe-0">
                  ...
                  <Form.Control placeholder="" aria-label="discord" className="ps-0" />
                </InputGroup>
                <InputGroup className="mb-3">
                  <InputGroup.Text className="d-flex align-items-center pe-0">
                  ...
                  <Form.Control placeholder="" aria-label="youtube" className="ps-0" />
                </InputGroup>
                <InputGroup className="mb-3">
                  <InputGroup.Text className="d-flex align-items-center pe-0">
                  ...
                  <Form.Control placeholder="" aria-label="tiktok" className="ps-0" />
                </InputGroup>
                <InputGroup className="mb-3">
                  <InputGroup.Text>
      ...
      <div
        ...
        id="MakeOfferModal"
        tabIndex={-1}
        aria-labelledby="MakeOfferModalLabel"
        aria-hidden="true"
      >
        <Modal.Dialog className="modal-dialog-centered mobile-modal-bottom">
          <Modal.Header>
          ...
          <Modal.Body>
            <Form>
              <Form.Group className="mb-3">
                ...
                <Form.Text className="color-grey mt-1">Current price — 49.9 TON</Form.Text>
              </Form.Group>
              <Form.Group className="mb-4">
                ...
                <Form.Text className="color-grey">
                  Until 8 Mar, 2:44 AM. If the owner does not accept your offer within this period
                  of time, the paid TON will be sent back to your wallet.
                </Form.Text>
              </Form.Group>
              <Button
                variant="primary w-100"
          ...
          <Modal.Body>
            <Form>
              <Form.Group controlId="formFile">
                <Form.Label
                  forHtml="formFile"
                  className="upload-image py-5 mb-4"
                  style={{
                    background:
                      'url(./assets/img/profile-banner.jpg) no-repeat center center / cover',
                    maxHeight: '30vh',
                    width: '100%',
                  }}
                >
              ...
              <Form.Group controlId="formFile" className="mb-4">
                <Form.Label forHtml="formFile" className="d-flex align-items-center">
                  <div
                    className="upload-image upload-image__profile me-3"
                    style={{
                      background: 'url(./assets/img/my-avatar.png) no-repeat center center / cover',
                    }}
                  >
      ...
      <div
        ...
        id="PutonSaleModal"
        tabIndex={-1}
        aria-labelledby="PutonSaleLabel"
        aria-hidden="true"
      >
        <Modal.Dialog className="modal-dialog-centered mobile-modal-bottom">
          <Modal.Header>
          ...
          <Modal.Body>
            <Button
              variant="link bg-soft hover text-white text-start d-flex w-100 p-3 mb-4"
              data-bs-toggle="modal"
            ...
            <Button
              variant="link bg-soft hover text-white text-start d-flex w-100 p-3"
              data-bs-toggle="modal"
              data-bs-target="#PutAuctionModal"
            >
              <i className="fa-regular fa-gavel fs-20 mt-1" />
              <div className="ms-3">
                <div className="fs-18 fw-medium mb-1">Auction</div>
                <div className="color-grey fs-14">Allow other users to bet on your NFT</div>
              </div>
              <i className="fa-regular fa-angle-right ms-auto" />
            </Button>
          </Modal.Body>
      ...
      <div
        ...
        id="EnterPriceModal"
        tabIndex={-1}
        aria-labelledby="EnterPriceModalLabel"
        aria-hidden="true"
      >
        <Modal.Dialog className="modal-dialog-centered mobile-modal-bottom">
          <Modal.Header>
              ...
              <ListGroup.Item className="d-flex border-bottom mb-3">
                <div className="color-grey">
                  ...
                  <OverlayTrigger
                    ...
                    overlay={
                      <Tooltip id={`tooltip-bottom`}>
                        This is the percentage creators receive each time their NFTs are sold on the
                        secondary market.
                      </Tooltip>
                    }
                  >
      ...
      <div
        ...
        id="EndAuctionModal"
        tabIndex={-1}
        aria-labelledby="EndAuctionModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered mobile-modal-bottom">
          <div className="modal-content border-0">
            <div className="modal-header border-0 mb-4">
              <h5 className="modal-title fs-24" id="SelectTypeModalLabel">
                Bets are no longer accepted
              </h5>
              <button
                type="button"
                className="border-0 p-0 modal-close"
                data-bs-dismiss="modal"
                aria-label="Close"
              >
                <i className="fa-solid fa-xmark fa-lg" />
            ...
            <div className="modal-body">
              <div className="p-3 p-md-4 border rounded text-center mb-4">
                <div className="fs-18 mb-4">
                  Scan the QR code and pay <span className="fw-bold">0.05 TON</span> <br /> to
                  Tonkeeper
                </div>
                <img
                ...
                <a href="#!" className="d-block">
                  <i className="fa-regular fa-copy me-2" /> Copy address
                </a>
              </div>
      ...
      <div
        ...
        id="PutAuctionModal"
        tabIndex={-1}
        aria-labelledby="PutAuctionModalLabel"
        aria-hidden="true"
      >
        <Modal.Dialog className="modal-dialog-centered mobile-modal-bottom">
          <Modal.Header className="mb-2">
            ...
            <Form>
              <Form.Group className="mb-4">
                ...
                <Form.Text className="color-grey d-block mb-3">
                  Bids below this amount won’t be allowed. You will only be able to accept the most
                  recent high bid.
                </Form.Text>
              ...
              <Form.Group className="mb-4">
                ...
                <Form.Text className="color-grey d-block mb-3">
                  Until 6 Mar, 10:49 PM. The auction will end automatically and the highest bidder
                  will win.
                </Form.Text>
                <Form.Select className="mb-2">
                  <option>7 Days</option>
              ...
              <Form.Group className="mb-4">
                <div className="d-flex align-items-center mb-2">
                  <Form.Label htmlFor="maxBid-switch" className="m-0">
                    Max. bid
                  </Form.Label>
                  <Form.Check type="switch" id="maxBid-switch" className="ms-auto" />
                </div>
                <Form.Text className="color-grey fs-12">
                  If anyone bids this amount, the NFT will be transferred <br /> to the bidder, and
      ...
      <div
        ...
        id="AboutAuctions"
        tabIndex={-1}
        aria-labelledby="AboutAuctionsModalLabel"
        aria-hidden="true"
      >
        <Modal.Dialog className="modal-dialog-centered mobile-modal-bottom">
          <Modal.Header>
            ...
            <ListGroup className="p-0 bg-transparent mb-4" as="ol" numbered>
              <ListGroup.Item as="li" className="d-flex fs-20">
                <div className="ms-3 fs-16">
                  The seller places their NFT up for auction and sets the minimum bid, start date,
                  and expiration date of the auction.
                </div>
              </ListGroup.Item>
              <ListGroup.Item as="li" className="d-flex fs-20">
                <div className="ms-3 fs-16">
                  When a bidder makes a bid, TON is deducted from their wallet balance, which will
                  be stored on the balance of the auction contract. It’s safe: The TONs is on the
                  blockchain, and no one else has access to it.
                </div>
              </ListGroup.Item>
              <ListGroup.Item as="li" className="d-flex fs-20">
                <div className="ms-3 fs-16">
              ...
              <ListGroup.Item as="li" className="d-flex fs-20">
                <div className="ms-3 fs-16">
                  If another user outbids the current bid, the amount of Toncoin minus blockchain
                  fees will be returned to the participant.
                </div>
              </ListGroup.Item>
              <ListGroup.Item as="li" className="d-flex fs-20">
                <div className="ms-3 fs-16">
                  Within 48 hours after the end of the auction, the seller will only be able to
                  accept the highest available bid made during the auction. As with regular
                  transactions, the seller will need to pay a gas fee to accept the bid.
                </div>
              </ListGroup.Item>
              <ListGroup.Item as="li" className="d-flex fs-20">
                <div className="ms-3 fs-16">
                  If the seller accepts the participant’s bid, the NFT will be instantly credited to
                  the bidder’s wallet, and the bid in TON will be credited to the seller’s wallet.
                </div>
              </ListGroup.Item>
            </ListGroup>
          </Modal.Body>
