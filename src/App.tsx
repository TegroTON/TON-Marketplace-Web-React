...
const DeLabConnector = new DeLabConnect('https://libermall.com', 'Libermall', 'mainnet');
...
export const App: React.FC = () => {
  ...
  const input = new VldBuilder().with(vlds.VLen, 4, 128).withFname('Merchant name');

  function consoleLog(data: string, type: boolean = false) {
    setSnackbar(
      <Snackbar
        before={type ? <Icon28CheckCircleFill /> : <Icon28CancelCircleFillRed />}
